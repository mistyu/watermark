...
class BasePickerViewState extends State<BasePickerView> {
  ...
  _body() {
    ...
    // KColors.dynamicColor(context, KColors.kPickerBgColor, KColors.kPickerBgDarkColor);
    var headerColor = const Color.fromARGB(255, 248, 248, 248);
    // KColors.dynamicColor(context, KColors.kPickerHeaderColor, KColors.kPickerHeaderDarkColor);
    var headerLineColor = Colors.grey;
    ...
    // KColors.dynamicColor(context, KColors.kPickerTitleColor, KColors.kPickerTitleDarkColor);
    var btnColor = const Color(0xFF323232);
    // Colors.blue;
    // KColors.dynamicColor(context, KColors.kPickerBtnColor, KColors.kPickerBtnDarkColor);
    var selectTextColor = Colors.black;
    // KColors.dynamicColor(context, KColors.kPickerTextColor, KColors.kPickerTextDarkColor);
